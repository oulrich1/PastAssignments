...
class Event_manager
{
  public:
    ...
    bool push_statement_block(Window::Keystroke keystroke, Statement_block* stmt_block);

    ~Event_manager();

  private:
    std::vector<Statement_block*> *keystroke_mappedto_stmt_block_v; // array of vectors containing ptrs to statement blocks
