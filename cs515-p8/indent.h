...
How to use:
  ...
  If the entire program shares a single indent object, you can print
  nested structures and the indentation will always be correct.
...
class Indent
{
  ...
  public:
    ...
    Indent &operator++() {m_level +=2; return *this;}
    Indent &operator--()
      {m_level-=2; if (m_level < 0) m_level = 0; return *this;}

    // overload post-fix ++ and --
    // this is weird, but putting that int there makes it post-fix
    Indent &operator++(int) {m_level+=2; return *this;}
    Indent &operator--(int)
      {m_level-=2; if (m_level < 0) m_level = 0; return *this;}

    Indent &operator+=(int i) {m_level+=i; return *this;}
    Indent &operator-=(int i)
      {m_level-=i; if (m_level < 0) m_level = 0; return *this;}
